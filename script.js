...
const translations = {
  en: {
    ...
    "app.lotto.desc": "Get your lucky numbers for today. AI recommended lotto numbers!",
  ...
  ko: {
    ...
    "hero.subtitle": "코드가 놀이가 되는 곳 🚀",
    "app.lotto.title": "Lotto Pick",
    "app.lotto.desc": "오늘의 행운 번호를 뽑아보세요. AI가 추천하는 로또 번호!",
    "app.money.title": "Money Weather",
    "app.money.desc": "오늘의 재정 날씨를 확인하세요.",
